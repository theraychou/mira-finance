...
test('health check passes with F19 hardening and WhatsApp routing configured', async () => {
  ...
  assert.notEqual(optional.find((item) => item.name === 'optional:customer-sheet-mirror').status, 'FAIL');
});
