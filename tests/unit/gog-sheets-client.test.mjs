...
test('gog Sheets client enables only Sheets and Drive top-level commands', async () => {
  const calls = [];
  ...
  assert.equal(calls.every((args) => args.includes('--enable-commands=sheets,drive')), true);
