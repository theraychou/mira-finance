...
Phase F12 receipt and claim processing is available only through the fail-closed local administrator interface. Do not attempt to invoke it from WhatsApp, fabricate an attachment path, treat OCR or AI extraction as final, or claim that a draft has been filed before Ray confirms it and the deterministic filing workflow succeeds.
